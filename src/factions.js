...
(function (root) {
  ...
  const source = {
    ...
    factions: [
      ...
      { id: 'BOS', name: 'Brotherhood of Steel', aliases: ['BoS'], player_selectable: true, recipe_code: 'BOS', asset_code: 'BOS', return_rate: null, return_rate_status: 'unknown' },
      { id: 'CMG', name: 'Colonization & Mining Guild', aliases: [], player_selectable: true, recipe_code: 'CMG', asset_code: 'CMG', return_rate: 0.85, return_rate_status: 'legacy-reviewed' },
      { id: 'EC', name: 'EuroCore / Eclipse Corporation', aliases: ['Eclipse Corporation', 'EuroCore'], player_selectable: true, recipe_code: 'EC', asset_code: 'EC', return_rate: null, return_rate_status: 'unknown' },
      { id: 'FDC', name: 'Freedom Defense Corps', aliases: ['Federal Defense Coalition'], player_selectable: true, recipe_code: 'FDC', asset_code: 'FDC', return_rate: null, return_rate_status: 'unknown' },
      { id: 'GOM', name: 'Guardians of Mankind', aliases: ['Global Operations Militia', 'GoM'], player_selectable: true, recipe_code: 'GOM', asset_code: 'GOM', return_rate: null, return_rate_status: 'unknown' },
      { id: 'LED', name: 'Law Enforcement Department', aliases: ['Law Enforcement Division'], player_selectable: true, recipe_code: 'LED', asset_code: 'LED', return_rate: null, return_rate_status: 'unknown' },
